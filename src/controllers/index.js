module.exports.authController = require('./Common/AuthController');
module.exports.fileController = require('./FilesController');
module.exports.partyController = require('./PartyController');
